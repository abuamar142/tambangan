...
export default function HomePage() {
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-md flex-col bg-teal-50 shadow-xl">
      <div className="bg-gradient-to-b from-teal-700 to-teal-600 px-4 pb-10 pt-12 text-center text-white">
      ...
      <div className="mx-auto -mt-5 w-full max-w-md flex-1 space-y-3 rounded-t-3xl bg-teal-50 px-4 pb-8 pt-6">
        <Link
          href="/tambangan"
