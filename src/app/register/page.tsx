...
export default function RegisterPage() {
  ...
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-md flex-col justify-center bg-teal-50 px-4 shadow-xl">
      <div className="mb-6 text-center">
        ...
        <p className="text-xs text-slate-500">Buat akun untuk mendaftarkan kapal</p>
      </div>
