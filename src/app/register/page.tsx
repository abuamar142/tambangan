        ...
        <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] p-6 shadow-xl dark:border-slate-700 dark:bg-slate-800 md:p-8">
          <div className="mb-6 flex items-center justify-between">
            <div className="flex-1 text-center">
              ...
              <p className="mt-1 text-sm text-[var(--color-text-secondary)] dark:text-slate-400">Buat akun untuk mendaftarkan kapal</p>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="confirm" className="mb-1.5 block text-xs font-semibold text-[var(--color-text-secondary)] dark:text-slate-400">
                Ulangi Password
              </label>
              <input
                id="confirm"
